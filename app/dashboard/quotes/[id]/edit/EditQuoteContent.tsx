...
export default function EditQuoteContent() {
        ...
        <div className="p-6 sm:p-8">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
                    ...
                    <span>/</span>
                    <Link href={`/dashboard/quotes/${quoteId}`} className="hover:text-indigo-600">
                        {quoteId}
                    </Link>
                    <span>/</span>
                    <span>Edit</span>
                ...
                <p className="text-slate-500 mt-1">Update quote details</p>
            </div>
