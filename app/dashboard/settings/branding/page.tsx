...
export default function BrandingSettingsPage() {
    ...
    const isLocked = !hasFeature('CUSTOM_BRANDING');
            ...
            <div className={`space-y-8 relative ${isLocked ? 'pointer-events-none' : ''}`}>
                {isLocked && (
                    <div className="absolute inset-0 z-50 flex items-center justify-center">
                        ...
                        <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-slate-200 text-center max-w-sm mx-auto pointer-events-auto">
                            <div className="w-16 h-16 bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg>
                            </div>
                            <h3 className="text-xl font-bold text-slate-900 mb-2">Enterprise Feature</h3>
                            <p className="text-slate-600 mb-6">
                                Custom branding is restricted to our Business plan. Upgrade to remove Facturify branding and use your own logo.
                            </p>
                            <Link
                                href="/dashboard/subscription"
                                className="inline-block w-full py-3 px-4 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors shadow-md"
                            >
                                View Plans
                            </Link>
                        </div>
